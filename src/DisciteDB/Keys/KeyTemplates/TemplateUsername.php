...
final class TemplateUsername extends BaseKey
{
    
    protected ?string $name = 'username';
    
    protected ?string $alias = 'username';
    
    protected ?string $prefix = null;

    protected TypeString|TypeDate|TypeFloat|TypeInteger|TypeBinary $type = TypeString::Username;
